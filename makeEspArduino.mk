...
$(ELF_FILE): $(CORE_LIB) $(USER_LIBS) $(USER_OBJ)
	echo "LD $(notdir $(ELF_FILE))"
	$(LINK_PREBUILD)
...
$(MAIN_EXE): $(LIBMAIN_DST) $(ELF_FILE)
	...
	echo $(ESPTOOL2) $(FW_USER_ARGS) $(ELF_FILE) $(MAIN_EXE) $(FW_SECTS)
...
upload flash: all $(FS_IMAGE)
	#echo $(UPLOAD_COM)
	echo $(ESPTOOL_PY) write_flash -fs 1MB 0x0000 $(BOOT_LOADER) 0x2000 $(MAIN_EXE) $(SPIFFS_ADDR) $(FS_IMAGE) 0xFC000 esp_init_data_default.bin
	$(ESPTOOL_PY) write_flash -fs 1MB 0x0000 $(BOOT_LOADER) 0x2000 $(MAIN_EXE) $(SPIFFS_ADDR) $(FS_IMAGE) 0xFC000 esp_init_data_default.bin
